...
class Copy extends Component { 
  ...
  render() { 
    ...
    return (  
      <span>
        <CopyToClipboard onCopy={this.onCopy} text={ (typeof window !== 'undefined') ? (window.location) : null + '#' + this.props.id + '-anchor'}>
