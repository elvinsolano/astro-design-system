...
function Download() {
  ...
  <div className="flex items-center">
    ...
    <a href="https://drive.google.com/uc?export=download&id=1P7pbVb12su1NdGuxTSO_BzuxTLNzwZox" target="_blank" className="bg-white text-red-600 text-sm as-type-medium border rounded-full border-red-600 border-solid px-4 py-2"> 
