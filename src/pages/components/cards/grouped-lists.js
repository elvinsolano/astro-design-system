...
import guidance1 from "../../../assets/components/cards/Grouped List Card/Guidance/01 Guidance.png";
import guidance2 from "../../../assets/components/cards/Grouped List Card/Guidance/02 Guidance.png";
import guidance3 from "../../../assets/components/cards/Grouped List Card/Guidance/03 Guidance.png"; 
 
class ComponentsCardsGroupedListPage extends Component {   
  render() {  
        ...
        <aside className="fixed overflow-y-auto as-nav bg-white top-auto h-full border-r border-grey-500 border-solid">
          ...
          <nav>
            <ul className="">
              ...
              <li><Link to="components/cards/grouped-lists" className="block text-sm text-grey-400 w-full active bg-grey-700 font-semibold hover:bg-grey-100">Grouped Lists</Link>
        ...
        <div className="flex flex-col flex-1 mx-auto as-body w-full pb-5.5">
          <main className="pl-16 pr-16 pt-16">
            ...
            <div className="block md:flex justify-between pb-2 border-b border-greyStatus-200 mb-5">
              <Heading level="1" className="as-h1 as-type-medium">Grouped List Card</Heading>
              <Download />
            </div> 

            <section id="ui-examples" name="ui-examples" className="as-section"> 
              <p className="mb-4 text-greyStatus-600 tracking-wider">Grouped lists contain lists that are, in turn, grouped to form new, compound lists.</p>
              ...
              <ul className="mb-16 py-5 px-20 bg-placeholder-200 flex flex-col items-start justify-start">
                <li className="flex mb-3">
                  ...
                  <p className="text-greyStatus-600 ml-3">You have multiple <Link to="components/cards/list" className="inline text-status-100 hover:text-red-900 underline">lists</Link>.</p>
                </li> 
                <li className="flex mb-3">
                  <div className="as-guidance">
                    <svg className="fill-current mt-1" width="16" height="16" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
              ...
              <p className="mb-5 text-greyStatus-600 tracking-wider">How grouped lists are expressed as part of the UI.</p> 
              <Tabs>
                <TabList>
                  <Tab>01</Tab> 
                </TabList>
            ...
            <section id="details" name="details" className="as-section"> 
              ...
              <p className="mb-5 text-greyStatus-600 tracking-wider">Card details refer to elements that make up a grouped list.</p>
                ...
                <ol className="ml-3">
                  ...
                  <li className="text-sm">
                    <div className="flex">
                      ...
                      <p className="text-sm text-greyStatus-600">Groups can consist of Body Title Content or Body Subtitle Content</p>
                    </div>              
                  </li>  
                  <li className="text-sm">
                    <div className="flex">
                ...
                <ol className="ml-3">
                  ...
                  <li className="text-sm">
                    <div className="flex">
                      ...
                      <p className="text-sm text-greyStatus-600">View More always leads to an <Link to="components/overlays/grouped-lists" className="inline text-sm text-status-100 hover:text-red-900 underline">Overlay</Link></p>
                    </div>              
                  </li> 
                </ol> 
              </div>             
            ...
            <section id="guidance" name="guidance" className="as-section mb-16">
              ...
              <p className="mb-4 text-greyStatus-600 tracking-wider">Below are guidelines for grouped lists to adhere to.</p>
...
export default ComponentsCardsGroupedListPage;
