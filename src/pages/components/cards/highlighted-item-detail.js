      ...
      <div className="flex flex-col flex-1 mx-auto as-body w-full pb-5.5">
        <main className="ml-64 pl-16 pr-16 pt-16">
          ...
          <section id="ui-examples" name="ui-examples" className="mb-24"> 
            ...
            <p className="mb-5 text-greyStatus-600 tracking-wider">The highlighted item and detail card places emphasis on 1 list item with the option of displaying an image and the ability to include additional elements.</p> 
            <Tabs>
              <TabList>
                <Tab>01</Tab>  
              </TabList>
              ...
              <TabPanel>                  
                <div className=" mb-12 py-12 px-20 bg-placeholder-300 flex flex-wrap items-start justify-start">
                  <img src={uiexamplesHighlightedItemDetailCard1} className="" width="335" />
                </div> 
              </TabPanel>  
            </Tabs>
          </section>   
          ...
          <section id="details" name="details" className="mb-24"> 
            ...
            <div className="py-12 px-20 bg-placeholder-300 flex flex-wrap items-center justify-start">
              <img src={detailsHighlightedItemDetailCard1} className="" width="597" />
            </div> 
          </section>             
          ...
          <section id="padding" name="padding" className="mb-24"> 
            ...
            <div className="py-12 px-20 bg-placeholder-300 flex flex-wrap items-center justify-start">
              <img src={paddingHighlightedItemDetailCard1} className="" width="364" />
            </div> 
          </section>             
        </main>
      </div>
