...
import guidance1 from "../../../assets/components/cards/Highlighted Item _ Detail Card/Guidance/01 Guidance.png";
import guidance2 from "../../../assets/components/cards/Highlighted Item _ Detail Card/Guidance/02 Guidance.png";
import guidance3 from "../../../assets/components/cards/Highlighted Item _ Detail Card/Guidance/03 Guidance.png"; 
// import guidance4 from "../../../assets/components/cards/Highlighted Item _ Detail Card/Guidance/04 Guidance.png";  
import guidance5 from "../../../assets/components/cards/Highlighted Item _ Detail Card/Guidance/05 Guidance.png";  
import guidance6 from "../../../assets/components/cards/Highlighted Item _ Detail Card/Guidance/06 Guidance.png";  

class ComponentsCardsHighlightedItemDetailPage extends Component {   
  render() {  
        ...
        <aside className="fixed overflow-y-auto as-nav bg-white top-auto h-full border-r border-grey-500 border-solid">
          ...
          <nav>
            <ul className="">
              ...
              <li><Link to="components/cards/highlighted-item-detail" className="block text-sm text-grey-400 w-full active bg-grey-700 font-semibold hover:bg-grey-100">Highlighted Item &amp; Detail</Link>
        ...
        <div className="flex flex-col flex-1 mx-auto as-body w-full pb-5.5">
          <main className=" pl-16 pr-16 pt-16">
            ...
            <div className="block md:flex justify-between pb-2 border-b border-greyStatus-200 mb-5">
              <Heading level="1" className="as-h1 as-type-medium">Highlighted Item &amp; Detail Card</Heading>
              <Download />
            </div> 

            <section id="ui-examples" name="ui-examples" className="as-section">
              <p className="mb-4 text-greyStatus-600 tracking-wider">The highlighted item and detail card places emphasis on information.</p>
              ...
              <ul className="mb-16 py-5 px-20 bg-placeholder-200 flex flex-col items-start justify-start">
                <li className="flex mb-3">
                  ...
                  <p className="text-greyStatus-600 ml-3">You have an item you want to highlight.</p>
                </li>              
                <li className="flex mb-3">
                  <div className="as-guidance">
                    <svg className="fill-current mt-1" width="16" height="16" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <p className="text-greyStatus-600 ml-3">You have secondary data points with only text.</p>
                </li>
                <li className="flex mb-3">
                  <div className="as-guidance">
                    <svg className="fill-current mt-1" width="16" height="16" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
              ...
              <p className="mb-5 text-greyStatus-600 tracking-wider">How the highlighted item and detail card is expressed as part of the UI.</p> 
              <Tabs>
                <TabList>
                  <Tab>01</Tab>  
                </TabList>
            ...
            <section id="details" name="details" className="as-section"> 
              ...
              <p className="mb-5 text-greyStatus-600 tracking-wider">Card details refers to elements that make up the highlighted item and detail card.</p>
                ...
                <ol className="ml-3"> 
                  ...
                  <li className="text-sm">
                    <div className="flex">
                      ...
                      <p className="text-sm text-greyStatus-600">If there is a header, the maximum number of subtitles is 4</p>
                    </div>              
                  </li>  
                </ol>  
              </div>  
                ...
                <ol className="ml-3">
                  ...
                  <li className="text-sm">
                    <div className="flex">
                      ...
                      <p className="text-sm text-greyStatus-600">View More always leads to an <Link to="components/overlays/highlighted-item-detail" className="inline text-sm text-status-100 hover:text-red-900 underline">Overlay</Link></p>
                    </div>              
                  </li> 
                </ol> 
              </div>             
            ...
            <section id="guidance" name="guidance" className="as-section mb-16">
              ...
              <p className="mb-4 text-greyStatus-600 tracking-wider">Below is a list of guidelines for the highlighted item and detail card to adhere to.</p>
              <div className="flex flex-wrap -mx-4 mb-12">  
                <div className="w-grid px-4 mb-8">
                  ...
                  <div className="flex mb-3">
                    ...
                    <p className="text-sm text-greyStatus-600 ml-3">Do not make the body subtitle label clickable.</p>
                  </div>
                </div>
                ...
                <div className="w-grid px-4 mb-8">
                  ...
                  <div className="flex mb-3">
                    ...
                    <p className="text-sm text-greyStatus-600 ml-3">Do not let content force a card to exceed 55% of screen height. If exceeded, use "View More" button.</p>
                  </div>
                </div>
                ...
                <div className="w-grid px-4 mb-8">
                  ...
                  <div className="flex mb-3">
                    ...
                    <p className="text-sm text-greyStatus-600 ml-3">Highlighted Items can be featured without an arrow or picture.</p>
                  </div>                     
                </div>
                ...
                <div className="w-grid px-4 mb-8">
                  ...
                  <div className="flex mb-3">
                    ...
                    <p className="text-sm text-greyStatus-600 ml-3">Do replace an <Link to="../design/icons" className="inline text-status-100 hover:text-red-900 underline">avatar</Link> with an <Link to="../design/icons" className="inline text-status-100 hover:text-red-900 underline">initial image</Link> if the user has no available profile image.</p>
                  </div>  
                </div>
...
export default ComponentsCardsHighlightedItemDetailPage;
