...
import uiexamplesListCard1 from "../../../assets/components/cards/List Card/UI Examples/List Card 01.png";
import uiexamplesListCard2 from "../../../assets/components/cards/List Card/UI Examples/List Card 02.png";
import uiexamplesListCard3 from "../../../assets/components/cards/List Card/UI Examples/List Card 03.png";
import detailsListCard1 from "../../../assets/components/cards/List Card/Details/List Card Details.png";
        ...
        <main className="ml-64 pl-16 pr-16 pt-16">
            ...
            <Tabs>
              ...
              <TabPanel>                  
                <div className=" mb-12 py-12 px-20 bg-placeholder-300 flex flex-wrap items-start justify-start">
                  <img src={uiexamplesListCard1} className="" width="335" />
                </div> 
              </TabPanel>
              <TabPanel>
                <div className=" mb-12 py-12 px-20 bg-placeholder-300 flex flex-wrap items-start justify-start">
                  <img src={uiexamplesListCard2} className="" width="335" />
                </div>
              </TabPanel>
              <TabPanel>
                <div className=" mb-12 py-12 px-20 bg-placeholder-300 flex flex-wrap items-start justify-start">
                  <img src={uiexamplesListCard3} className="" width="335" />
                </div>
              </TabPanel>
            </Tabs>
          </section>   
          ...
          <section id="details" name="details" className="mb-24"> 
            ...
            <div className="py-12 px-20 bg-placeholder-300 flex flex-wrap items-center justify-start">
              <img src={detailsListCard1} className="" width="597" />
            </div> 
          </section>             
          ...
          <section id="padding" name="padding" className="mb-24"> 
            ...
            <div className="py-12 px-20 bg-placeholder-300 flex flex-wrap items-center justify-start">
              <img src={paddingListCard1} className="" width="365" />
            </div> 
          </section>             
        </main>
      </div>
...
export default ComponentsCardsListPage;
