      ...
      <div className="flex flex-col flex-1 mx-auto as-body w-full pb-5.5">
        <main className="ml-64 pl-16 pr-16 pt-16">
          ...
          <section id="ui-examples" name="ui-examples" className="mb-24"> 
            ...
            <p className="mb-5 text-greyStatus-600 tracking-wider">Single item with grouping cards are used to present information about 1 topic with multiple data points. There’s an unlimited number of groups for the body, which can each contain a maximum of 8 subtitles.</p> 
            <Tabs>
              <TabList>
                <Tab>01</Tab>
                <Tab>02</Tab>
              ...
              <TabPanel>                  
                <div className=" mb-12 py-12 px-20 bg-placeholder-300 flex flex-wrap items-start justify-start">
                  <img src={uiexamplesSingleItemGroupingCard1} className="" width="335" />
                </div> 
              </TabPanel>
              <TabPanel>
                <div className=" mb-12 py-12 px-20 bg-placeholder-300 flex flex-wrap items-start justify-start">
                  <img src={uiexamplesSingleItemGroupingCard2} className="" width="335" />
                </div>
              </TabPanel>
              <TabPanel>
                <div className=" mb-12 py-12 px-20 bg-placeholder-300 flex flex-wrap items-start justify-start">
                  <img src={uiexamplesSingleItemGroupingCard3} className="" width="335" />
                </div>
              </TabPanel>
            </Tabs>
          </section>   
          ...
          <section id="details" name="details" className="mb-24"> 
            ...
            <div className="py-12 px-20 bg-placeholder-300 flex flex-wrap items-center justify-start">
              <img src={detailsSingleItemGroupingCard1} className="" width="597" />
            </div> 
          </section>             
          ...
          <section id="padding" name="padding" className="mb-24"> 
            ...
            <div className="py-12 px-20 bg-placeholder-300 flex flex-wrap items-center justify-start">
              <img src={paddingSingleItemGroupingCard1} className="" width="365" />
            </div> 
          </section>             
        </main>
      </div>
