...
import uiexamplesHighlightedItemDetailOverlay1 from "../../../assets/components/overlays/Highlighted Item Overlay/UI Examples/Highlighted Item Overlay 01.png"; 
import detailsHighlightedItemDetailOverlay1 from "../../../assets/components/overlays/Highlighted Item Overlay/Details/Highlighted Item Overlay Details.png";
import paddingHighlightedItemDetailOverlay1 from "../../../assets/components/overlays/Highlighted Item Overlay/Padding/Highlighted Item Overlay Padding.png"; 

import guidance1 from "../../../assets/components/overlays/Highlighted Item Overlay/Guidance/01 Guidance.png";
import guidance2 from "../../../assets/components/overlays/Highlighted Item Overlay/Guidance/02 Guidance.png";
import guidance3 from "../../../assets/components/overlays/Highlighted Item Overlay/Guidance/03 Guidance.png";
import guidance4 from "../../../assets/components/overlays/Highlighted Item Overlay/Guidance/04 Guidance.png";
import guidance5 from "../../../assets/components/overlays/Highlighted Item Overlay/Guidance/05 Guidance.png";

function ComponentsOverlaysHighlightedItemDetailPage() { 
      ...
      <aside className="fixed overflow-y-auto as-nav bg-white top-auto h-full border-r border-grey-500 border-solid">
        ...
        <nav>
          ...
          <ul className="">
            ...
            <li><Link to="components/overlays/highlighted-item-detail" className="block text-sm text-grey-400 w-full hover:bg-grey-100 active bg-grey-700 font-semibold">Highlighted Item &amp; Detail</Link>
      ...
      <div className="flex flex-col flex-1 mx-auto as-body w-full pb-5.5">
        <main className=" pl-16 pr-16 pt-16">
          ...
          <section id="ui-examples" name="ui-examples" className="as-section"> 
            ...
            <ul className="mb-16 py-5 px-20 bg-placeholder-200 flex flex-col items-start justify-center">
              ...
              <li className="flex mb-3">
                ...
                <p className="text-greyStatus-600 ml-3">The information pertains to the item being highlighted.</p>
              </li>
              <li className="flex mb-3">
                <div className="as-guidance">
                  <svg className="fill-current mt-1" width="16" height="16" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
            ...
            <p className="mb-5 text-greyStatus-600 tracking-wider">How a highlighted item and detail card is expressed as part of the UI.</p>
            <Tabs>
              <TabList>
                <Tab>01</Tab> 
              </TabList>
              ...
              <ol className="ml-3">
                <li className="text-sm">
                  <div className="flex">
                    ...
                    <p className="text-sm text-greyStatus-600">Optional. Used when there are further details to the content.</p>
                  </div>              
                </li> 
              </ol> 
            </div>  
          ...
          <section id="guidance" name="guidance" className="as-section mb-16">
            ...
            <p className="mb-4 text-greyStatus-600 tracking-wider">Below is a list of guidelines for a highlighted item and detail card to adhere to.</p>
            <div className="flex flex-wrap -mx-4 mb-12">  
              ...
              <div className="w-grid px-4 mb-8">
                ...
                <div className="flex mb-3">
                  ...
                  <p className="text-sm text-greyStatus-600 ml-3">Do not limit content to a user’s View More link.</p>
                </div>
              </div>
...
export default ComponentsOverlaysHighlightedItemDetailPage;
