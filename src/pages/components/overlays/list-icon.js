...
import uiexamplesListIconOverlay1 from "../../../assets/components/overlays/List with Icons Overlay/UI Examples/List with Icons Overlay 01.png";  
import detailsListIconOverlay1 from "../../../assets/components/overlays/List with Icons Overlay/Details/List with Icons Overlay Details.png";
import paddingListIconOverlay1 from "../../../assets/components/overlays/List with Icons Overlay/Padding/List with Icons Overlay Padding.png"; 

import guidance1 from "../../../assets/components/overlays/List with Icons Overlay/Guidance/01 Guidance.png";
import guidance2 from "../../../assets/components/overlays/List with Icons Overlay/Guidance/02 Guidance.png";
import guidance3 from "../../../assets/components/overlays/List with Icons Overlay/Guidance/03 Guidance.png";
// import guidance4 from "../../../assets/components/overlays/List with Icons Overlay/Guidance/04 Guidance.png";
import guidance5 from "../../../assets/components/overlays/List with Icons Overlay/Guidance/05 Guidance.png";
import guidance6 from "../../../assets/components/overlays/List with Icons Overlay/Guidance/06 Guidance.png";

class ComponentsOverlaysListIconPage extends Component { 
  render(){
        ...
        <div className="flex flex-col flex-1 mx-auto as-body w-full pb-5.5">
          <main className=" pl-16 pr-16 pt-16">
            ...
            <section id="ui-examples" name="ui-examples" className="as-section">
              <p className="mb-4 text-greyStatus-600 tracking-wider">List with icons overlays display information in a clear and simple hierarchical order. The information displayed generally has identical structure and repeats. These overlays can contain elements including text, data, badges and links.</p>
              ...
              <p className="mb-5 text-greyStatus-600 tracking-wider">How a list with icons overlay is expressed as part of the UI.</p>
              <Tabs>
                <TabList>
                  <Tab>01</Tab>  
                </TabList>
            ...
            <section id="details" name="details" className="as-section"> 
              ...
              <p className="mb-5 text-greyStatus-600 tracking-wider">Overlay details refer to elements that make up a list with icons overlay.</p>
            ...
            <section id="guidance" name="guidance" className="as-section mb-16">
              ...
              <p className="mb-4 text-greyStatus-600 tracking-wider">Below is a list of guidelines for a list with icons overlay.</p>
...
export default ComponentsOverlaysListIconPage;
