...
import uiexamplesProfileOverlay1 from "../../../assets/components/overlays/Profile List Overlay/UI Examples/Profile List Overlay 01.png"; 
import detailsProfileOverlay1 from "../../../assets/components/overlays/Profile List Overlay/Details/Profile List Overlay Details.png";
import paddingProfileOverlay1 from "../../../assets/components/overlays/Profile List Overlay/Padding/Profile List Overlay Padding.png"; 
...
class ComponentsOverlaysProfilePage extends Component { 
  render(){
        ...
        <aside className="fixed overflow-y-auto as-nav bg-white top-auto h-full border-r border-grey-500 border-solid">
          ...
          <nav>
            ...
            <ul className="">
              ...
              <li><Link to="components/overlays/profile-list" className="block text-sm text-grey-400 w-full hover:bg-grey-100 active bg-grey-700 font-semibold">Profile List</Link>
        ...
        <div className="flex flex-col flex-1 mx-auto as-body w-full pb-5.5">
          <main className=" pl-16 pr-16 pt-16">
            ...
            <div className="block md:flex justify-between pb-2 border-b border-greyStatus-200 mb-5">
              <Heading level="1" className="as-h1 as-type-medium">Profile List Overlay</Heading>
              <Download />
            </div> 

            <section id="ui-examples" name="ui-examples" className="as-section"> 
              <p className="mb-4 text-greyStatus-600 tracking-wider">Profile list overlays display information in a clear and simple hierarchical order with elements that have identical structure. In this specific case, a list of profiles. They can contain elements including text, data, images, badges and links.</p>
              ...
              <ul className="mb-16 py-5 px-20 bg-placeholder-200 flex flex-col items-start justify-center">
                <li className="flex mb-3">
                  ...
                  <p className="text-greyStatus-600 ml-3">You have multiple profile items to display or multiple items with an avatar image or initial image to display.</p>
                </li>
                <li className="flex mb-3">
                  <div className="as-guidance">
                    <svg className="fill-current mt-1" width="16" height="16" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
              ...
              <p className="mb-5 text-greyStatus-600 tracking-wider">How an overlay for a profile list card is expressed as part of the UI.</p>
              <Tabs>
                <TabList>
                  <Tab>01</Tab> 
                </TabList>
            ...
            <section id="guidance" name="guidance" className="as-section mb-16">
              ...
              <p className="mb-4 text-greyStatus-600 tracking-wider">Below is a list of guidelines for a profile list card to adhere to.</p>
              <div className="flex flex-wrap -mx-4 mb-12">  
                <div className="w-grid px-4 mb-8">
                  ...
                  <div className="flex mb-3">
                    ...
                    <p className="text-sm text-greyStatus-600 ml-3">Do not change the structure of the profile list overlay.</p>
                  </div>
                </div>
...
export default ComponentsOverlaysProfilePage;
