...
// import uiexamplesProfileOverlay1 from "../../../assets/components/overlays/Profile Overlay/UI Examples/Profile Overlay 01.png"; 
// import detailsProfileOverlay1 from "../../../assets/components/overlays/Profile Overlay/Details/Profile Overlay Details.png";
// import paddingProfileOverlay1 from "../../../assets/components/overlays/Profile Overlay/Padding/Profile Overlay Padding.png"; 
      ...
      <aside className="fixed overflow-y-auto as-nav bg-white top-auto h-full border-r border-grey-500 border-solid w-64">
        <nav>
          ...
          <ul className="">
            ...
            <li><Link to="components/overlays/profile" className="block text-sm text-grey-400 w-full hover:bg-grey-100 active bg-grey-700 font-semibold">Profile</Link>
      ...
      <div className="flex flex-col flex-1 mx-auto as-body w-full pb-5.5">
        <main className="ml-64 pl-16 pr-16 pt-16">
          ...
          <section id="ui-examples" name="ui-examples" className="mb-24"> 
            ...
            <p className="mb-5 text-greyStatus-600 tracking-wider">The overlay for a profile card displays all the possible content that is not contained in the card, which can include text, data, and links.</p>
            <Tabs>
              <TabList>
                <Tab>01</Tab> 
              </TabList>
              ...
              <TabPanel>                  
                <div className="mb-12 py-12 px-20 bg-placeholder-300 flex flex-wrap items-start justify-start">
                  {/* <img src={uiexamplesProfileOverlay1} className="" width="335" /> */}
                </div> 
              </TabPanel> 
            </Tabs>
          </section>   
          ...
          <section id="details" name="details" className="mb-24"> 
            ...
            <div className="py-12 px-20 bg-placeholder-300 flex flex-wrap items-center justify-start">
              {/* <img src={detailsProfileOverlay1} className="" width="690" /> */}
            </div> 
          </section>             
          ...
          <section id="padding" name="padding" className="mb-24"> 
            ...
            <div className="py-12 px-20 bg-placeholder-300 flex flex-wrap items-center justify-start">
              {/* <img src={paddingProfileOverlay1} className="" width="402" /> */}
            </div> 
          </section>             
        </main>
      </div>
