...
import uiexamplesTasksOverlay1 from "../../../assets/components/overlays/Task Overlay/UI Examples/Task Overlay 01.png"; 
import detailsTasksOverlay1 from "../../../assets/components/overlays/Task Overlay/Details/Task Overlay Details.png";
import paddingTasksOverlay1 from "../../../assets/components/overlays/Task Overlay/Padding/Task Overlay Padding.png"; 

function ComponentsOverlaysTasksPage() { 
        ...
        <main className="ml-64 pl-16 pr-16 pt-16">
            ...
            <Tabs>
              ...
              <TabPanel>                  
                <div className="mb-12 py-12 px-20 bg-placeholder-300 flex flex-wrap items-start justify-start">
                  <img src={uiexamplesTasksOverlay1} className="" width="335" />
                </div> 
              </TabPanel> 
            </Tabs>
          </section>   
          ...
          <section id="details" name="details" className="mb-24"> 
            ...
            <div className="py-12 px-20 bg-placeholder-300 flex flex-wrap items-center justify-start">
              <img src={detailsTasksOverlay1} className="" width="690" />
            </div> 
          </section>             
          ...
          <section id="padding" name="padding" className="mb-24"> 
            ...
            <div className="py-12 px-20 bg-placeholder-300 flex flex-wrap items-center justify-start">
              <img src={paddingTasksOverlay1} className="" width="402" />
            </div> 
          </section>             
        </main>
      </div>
...
export default ComponentsOverlaysTasksPage;
