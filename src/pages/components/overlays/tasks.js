...
import guidance1 from "../../../assets/components/overlays/Task Overlay/Guidance/01 Guidance.png";
import guidance2 from "../../../assets/components/overlays/Task Overlay/Guidance/02 Guidance.png"; 

class ComponentsOverlaysTasksPage extends Component { 
  render(){
        ...
        <div className="flex flex-col flex-1 mx-auto as-body w-full pb-5.5">
          <main className=" pl-16 pr-16 pt-16">
            ...
            <section id="ui-examples" name="ui-examples" className="as-section"> 
              <p className="mb-4 text-greyStatus-600 tracking-wider">Task overlays display information about user tasks or objectives in a simple, clear order. They may contain elements including text, data, check marks, badges and links.</p>
            ...
            <section id="guidance" name="guidance" className="as-section mb-16">
              ...
              <p className="mb-4 text-greyStatus-600 tracking-wider">Below is a list of guidelines for an overlay for a task card to adhere to.</p>
              <div className="flex flex-wrap -mx-4 mb-12">  
                <div className="w-grid px-4 mb-8">
                  ...
                  <div className="flex mb-3">
                    ...
                    <p className="text-sm text-greyStatus-600 ml-3">Do not hyperlink tasks.</p>
                  </div>
                </div>
