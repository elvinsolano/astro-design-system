...
import uiexamplesTwoColumnsOverlay1 from "../../../assets/components/overlays/Two Column Overlay/UI Examples/Two Column Overlay 01.png"; 
import detailsTwoColumnsOverlay1 from "../../../assets/components/overlays/Two Column Overlay/Details/Two Column Overlay Details.png";
import paddingTwoColumnsOverlay1 from "../../../assets/components/overlays/Two Column Overlay/Padding/Two Column Overlay Padding.png"; 

import guidance1 from "../../../assets/components/overlays/Two Column Overlay/Guidance/01 Guidance.png";
import guidance2 from "../../../assets/components/overlays/Two Column Overlay/Guidance/02 Guidance.png";
import guidance3 from "../../../assets/components/overlays/Two Column Overlay/Guidance/03 Guidance.png";
import guidance4 from "../../../assets/components/overlays/Two Column Overlay/Guidance/04 Guidance.png";
import guidance5 from "../../../assets/components/overlays/Two Column Overlay/Guidance/05 Guidance.png";
import guidance6 from "../../../assets/components/overlays/Two Column Overlay/Guidance/06 Guidance.png"; 

class ComponentsOverlaysTwoColumnsPage extends Component { 
  render(){
        ...
        <aside className="fixed overflow-y-auto as-nav bg-white top-auto h-full border-r border-grey-500 border-solid">
          ...
          <nav>
            ...
            <ul className="">
              ...
              <li><Link to="components/overlays/two-columns" className="block text-sm text-grey-400 w-full hover:bg-grey-100 active bg-grey-700 font-semibold">Two Column</Link>
        ...
        <div className="flex flex-col flex-1 mx-auto as-body w-full pb-5.5">
          <main className=" pl-16 pr-16 pt-16">
            ...
            <div className="block md:flex justify-between pb-2 border-b border-greyStatus-200 mb-5">
              <Heading level="1" className="as-h1 as-type-medium">Two Column Overlay</Heading>
              <Download />
            </div> 
            ...
            <section id="ui-examples" name="ui-examples" className="as-section"> 
              ...
              <p className="mb-5 text-greyStatus-600 tracking-wider">How two-column cards are expressed as part of the UI.</p>
              <Tabs>
                <TabList>
                  <Tab>01</Tab> 
                </TabList>
            ...
            <section id="details" name="details" className="as-section"> 
              ...
              <p className="mb-5 text-greyStatus-600 tracking-wider">Overlay details refer to elements that make up a two column overlay.</p>
            ...
            <section id="guidance" name="guidance" className="as-section mb-16">
              ...
              <p className="mb-4 text-greyStatus-600 tracking-wider">Below is a list of guidelines for a two-column cards to adhere to.</p>
              <div className="flex flex-wrap -mx-4 mb-12">  
                ...
                <div className="w-grid px-4 mb-8">
                  ...
                  <div className="flex mb-3">
                    ...
                    <p className="text-sm text-greyStatus-600 ml-3">Do not show percentage values in a two-column 0verlay. You can use percentage values in a <Link to="components/overlays/progress-bar" className="inline text-sm text-status-100 hover:text-red-900 underline">Progress Bar</Link> overlay.</p>
                  </div>
                </div>
...
export default ComponentsOverlaysTwoColumnsPage;
