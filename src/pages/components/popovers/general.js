...
import uiexamplesGeneral1 from "../../../assets/components/popovers/General/UI Examples/popover-general-example-01.png"; 
import detailsGeneral1 from "../../../assets/components/popovers/General/Details/popover-general-details.png";
import paddingGeneral1 from "../../../assets/components/popovers/General/Padding/popover-general-padding.png"; 

class ComponentsPopoversGeneralPage extends Component { 
  render(){
        ...
        <aside className="fixed overflow-y-auto as-nav bg-white top-auto h-full border-r border-grey-500 border-solid">
          ...
          <nav>
            ...
            <ul className="">
              ...
              <li><Link to="components/popovers/general" className="block text-sm text-grey-400 w-full active bg-grey-700 font-semibold hover:bg-grey-100">General</Link>
                <Scrollspy items={ ['ui-examples', 'padding',  'details',  'guidance'] } offset={-80} className="block" currentClassName="is-current">
                  <li><Link to="components/popovers/general#ui-examples-anchor" className="block text-sm text-grey-400 w-full hover:bg-grey-100" activeClassName="block text-sm text-grey-400 w-full bg-grey-200 font-semibold hover:bg-grey-100">UI Examples</Link></li> 
                  <li><Link to="components/popovers/general#padding-anchor" className="block text-sm text-grey-400 w-full hover:bg-grey-100" activeClassName="active-link">Padding</Link></li>
                  <li><Link to="components/popovers/general#details-anchor" className="block text-sm text-grey-400 w-full hover:bg-grey-100" activeClassName="active-link">Details</Link></li>
                  <li><Link to="components/popovers/general#guidance-anchor" className="block text-sm text-grey-400 w-full hover:bg-grey-100" activeClassName="active-link">Guidance</Link></li>
                </Scrollspy>    
              </li>   
            </ul>                    
          </nav>
        ...
        <div className="flex flex-col flex-1 mx-auto as-body w-full pb-5.5">
          <main className=" pl-16 pr-16 pt-16">
            ...
            <div className="block md:flex justify-between pb-2 border-b border-greyStatus-200 mb-5">
              <Heading level="1" className="as-h1 as-type-medium">General</Heading>
              <Download />
            </div> 
  
            <section id="ui-examples" name="ui-examples" className="as-section"> 
              <p className="mb-4 text-greyStatus-600 tracking-wider">General popovers are interactive screens designed to "pop up" in order to give the user guidance and options for managing features or services within Astro.</p>
              ...
              <ul className="mb-16 py-5 px-20 bg-placeholder-200 flex flex-col items-start justify-center">
                <li className="flex mb-3">
                  ...
                  <p className="text-greyStatus-600 ml-3">You need the user’s attention.</p>
                </li> 
                <li className="flex">
                  <div className="as-guidance">
                    <svg className="fill-current mt-1" width="16" height="16" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <p className="text-greyStatus-600 ml-3">You are keeping the user within the app.</p>
                </li> 
              </ul>          
              ...
              <p className="mb-5 text-greyStatus-600 tracking-wider">How general popovers are expressed as part of the UI.</p>
              <Tabs>
                <TabList> 
                  <Tab>01</Tab> 
                </TabList>
            ...
            <section id="details" name="details" className="as-section"> 
                ...
                <ol className="ml-3">
                  <li className="text-sm">
                    <div className="flex">
                      ...
                      <p className="text-sm text-greyStatus-600">Must always have Title 2</p>
                    </div>              
                  </li>
                  <li className="text-sm">
                    <div className="flex">
              ...
              <div className="mb-6">
                <p className="as-type-regular text-sm text-greyStatus-600">2. <span className="as-type-medium">Body Title Label</span></p>
                <ol className="ml-3">
                  <li className="text-sm">
                    <div className="flex">
                      <div className=" ml-3">
              ...
              <div className="mb-6">
                <p className="as-type-regular text-sm text-greyStatus-600">3. <span className="as-type-medium">Primary Enabled</span></p>
                <ol className="ml-3">
                  <li className="text-sm">
                    <div className="flex">
                      <div className="ml-3">
              ...
              <div className="flex flex-col -mx-4">  
                <div className="w-full px-4 mb-4"> 
                  <div className="flex mb-3">
                    ...
                    <p className="text-sm text-greyStatus-600 ml-3">Do not use this popover to prompt a user to leave the app. Use <Link to="components/popovers/external" className="inline text-sm text-status-100 hover:text-red-900 underline">External Popover</Link> to leave the app.</p>
                  </div>
                </div> 
                <div className="w-full px-4">  
                  <div className="flex mb-3">
                    ...
                    <p className="text-sm text-greyStatus-600 ml-3">Do use this popover to prompt a user to navigate within the app.</p>
                  </div>
                </div> 
...
export default ComponentsPopoversGeneralPage;
