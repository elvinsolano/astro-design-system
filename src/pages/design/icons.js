          ...
          <main className="pl-16 pr-16 pt-16">
            ...
            <div className="block md:flex justify-between pb-2 border-b border-greyStatus-200 mb-5">
              ...
              <div className="flex flex-wrap items-center">
                ...
                {/* <a href="https://drive.google.com/uc?export=download&id=13QVAUUjXvZTH_UH8FFuAdSkIW1XENav5" target="_blank"  rel="noopener noreferrer" className="bg-white text-red-600 text-sm as-type-medium border rounded-full border-red-600 border-solid px-4 py-2">  */}
                <a href="https://drive.google.com/uc?export=download&id=1P7pbVb12su1NdGuxTSO_BzuxTLNzwZox" target="_blank"  rel="noopener noreferrer" className="bg-white text-red-600 text-sm as-type-medium border rounded-full border-red-600 border-solid px-4 py-2"> 
