      ...
      <aside className="fixed overflow-y-auto as-nav bg-white top-auto h-full border-r border-grey-500 border-solid w-64">
        <nav>
          <ul className=""> 
            ...
            <li><a href="pictograms" className="block text-sm text-grey-400 w-full active bg-grey-700 font-semibold hover:bg-grey-100 focus:bg-grey-800 focus:font-semibold">Pictograms</a>
              <ul className="block">
        ...
        <main className="ml-64 pl-16 pr-16 pt-16">
          <section className="">
            ...
            <div className="flex justify-between rounded py-1 px-3 bg-grey-100 mb-16">
              <Heading level="2" className="gw-h1">Pictograms</Heading>
