...
class ElementsLoadersPage extends Component {   
  render() {  
    return (
      <Layout>
        <SEO
          ...
          <main className=" pl-16 pr-16 pt-16">
            ...
            <section id="types" name="types" className="as-section"> 
              ...
              <div className="mb-16">
                ...
                <Heading level="3" className="as-h3 as-type-medium mb-3">Pull-Down Loaders
                  <Copy id="types-pull-down-loaders" />          
                </Heading>  
            ...
            <section id="specs" name="specs" className="as-section"> 
              ...
              <div className="mb-16">
                ...
                <Heading level="3" className="as-h3 as-type-medium mb-3">Pull-Down Loaders
                  <Copy id="specs-pull-down-loaders" />      
                </Heading>  
