      ...
      <aside className="fixed overflow-y-auto pt-20 bg-white top-auto h-full border-r border-grey-500 border-solid w-64">
        <nav>
          <ul className="">  
            ...
            <li><Link to="elements/dividers" className="block text-sm text-grey-400 pl-12 py-2 w-full hover:bg-grey-100 focus:bg-grey-800 focus:font-semibold">Dividers</Link></li>
            ...
            <li><Link to="elements/loaders" className="block text-sm text-grey-400 pl-12 py-2 w-full active bg-grey-700 font-semibold hover:bg-grey-100 focus:bg-grey-800 focus:font-semibold">Loaders</Link> 
        ...
        <main className="ml-64 pl-16 pr-16 pt-16">
            ...
            <Tabs>
              ...
              <TabPanel>
                <div className="mb-12 py-12 px-20 bg-placeholder-300 flex">
                  <img src={usagePullDownLoader1} className="" width="375px" /> 
                </div> 
              </TabPanel>
              <TabPanel>
                <div className="mb-12 py-12 px-20 bg-placeholder-300 flex">
                  <img src={usageGeneralLoader1} className="" width="375px" />
                  <img src={usageGeneralLoader2} className="" width="375px" /> 
                </div>
              </TabPanel> 
            </Tabs>
          </section>
          ...
          <section id="specs" name="specs" className="mb-24"> 
            ...
            <div className="mb-16">
              ...
              <ol className="mb-5 py-12 px-20 bg-placeholder-200 flex flex-wrap items-start justify-start">
                <li className="as-grid-4 relative mb-12"><span className="list-circle">1</span><img src={specsPullDownLoader1} className="inline-block" width="264" height="93" /> </li>
              </ol>  
          ...
          <section id="guidance" name="guidance" className="mb-48">
            ...
            <div className="flex flex-wrap -mx-4 mb-12">  
              ...
              <div className="w-grid px-4 mb-8">
                ...
                <img src={guidanceDividers4} className="mb-3" width="290" />
